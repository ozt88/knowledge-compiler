...
## Current Milestone: v1.2 Token Optimization

**Goal:** 클라이언트 단에서 CLI 출력을 압축해 LLM 토큰 소비를 60-90% 절감하는 도구를 선정·설치·설정한다

**Target features:**
- RTK vs 유사 도구 비교 분석 (클라이언트 전용, 텔레메트리 없는 도구 대상)
- 최적 도구 선정 및 사내 보안 규정 준수 확인 (텔레메트리 완전 비활성화)
- knowledge-compiler 프로젝트에 선정 도구 설치·구성
